...
-- CreateEnum
CREATE TYPE "public"."skill_importance" AS ENUM ('low', 'medium', 'high', 'critical');
...
-- CreateEnum
CREATE TYPE "public"."ticket_status" AS ENUM ('todo', 'in_progress', 'waiting_for_customer', 'resolved', 'closed', 'cancelled');
...
CREATE TABLE "public"."ticket_skills" (
    ...
    CONSTRAINT "ticket_skills_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "public"."user_skills" (
    ...
    "user_id" UUID NOT NULL,
    "skill_name" VARCHAR(100) NOT NULL,
    "proficiency_level" "public"."skill_proficiency" NOT NULL DEFAULT 'beginner',
    "created_at" TIMESTAMPTZ(6) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- CreateIndex
CREATE INDEX "idx_ticket_skills_skill_name" ON "public"."ticket_skills"("skill_name");

-- CreateIndex
CREATE INDEX "idx_ticket_skills_ticket_id" ON "public"."ticket_skills"("ticket_id");

-- CreateIndex
CREATE UNIQUE INDEX "ticket_skill_unique" ON "public"."ticket_skills"("ticket_id", "skill_name");
...
-- CreateIndex
CREATE UNIQUE INDEX "user_skill_unique" ON "public"."user_skills"("user_id", "skill_name");
...
-- AddForeignKey
ALTER TABLE "public"."ticket_skills" ADD CONSTRAINT "ticket_skills_ticket_id_fkey" FOREIGN KEY ("ticket_id") REFERENCES "public"."tickets"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."tickets" ADD CONSTRAINT "tickets_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "public"."users"("id") ON DELETE SET NULL ON UPDATE NO ACTION;
